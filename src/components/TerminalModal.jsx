      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 overflow-hidden">
          ...
          <motion.div
            ...
            className={`relative flex flex-col w-full rounded-2xl bg-[#090c15] border border-slate-800 shadow-[0_25px_70px_rgba(0,0,0,0.95)] overflow-hidden z-10 transition-all duration-200 ${isMaximized ? 'h-[94vh] max-w-[96vw]' : 'max-w-3xl h-[590px] max-h-[85vh]'
              }`}
          >
            {/* Window Header */}
